...
/**
 * The assessment scorer. Pure arithmetic over the published career guides —
 * it never called a model, which is why it survived the removal of everything
 * that did. It used to live under `/api/v1/ai/assess`, a path that always
 * misdescribed it.
 *
